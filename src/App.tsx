          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button
                    onClick={() => handleNavigationChange('/how-it-works')}
                    className="text-gray-200 hover:text-white"
                  >
                    How It Works
                  </button>
                ...
                <li>
                  <button
                    onClick={() => handleNavigationChange('/sustainability')}
                    className="text-gray-200 hover:text-white"
                  >
                    Sustainability
                  </button>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button
                    onClick={() => handleNavigationChange('/contact')}
                    className="text-gray-200 hover:text-white"
                  >
                    Contact Us
                  </button>
                ...
                <li>
                  <button
                    onClick={() => handleNavigationChange('/shipping')}
                    className="text-gray-200 hover:text-white"
                  >
                    Shipping Info
                  </button>
